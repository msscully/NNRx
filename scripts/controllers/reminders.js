app.controller('ReminderCtrl', ['$scope', '$rootScope', '$location', '$routeParams', 'reminderStorage', 'uuid4', '$window', 'CordovaService', function ($scope, $rootScope, $location, $routeParams, reminderStorage, uuid4, $window, CordovaService) {
